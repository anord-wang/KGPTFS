...
for i in range(EXPLORE_STEPS):
    ...
    # compareLodge_loss = Representation_learning.compare_training(X_selected_tensor, X_tra
...
for model_index in range(model_num):
    ...
    output.append(str(model_index + 1) + 'mutil reg method reconstruction loss with knockoff.')
    reward_output.append(str(model_index + 1) + 'mutil reg method reconstruction loss with knockoff.')
