...
for model_index in range(8):
    ...
    output.append(str(model_index+1)+'mutil cla method reconstruction loss with knockoff.')
    reward_output.append(str(model_index+1)+'mutil cla method reconstruction loss with knockoff.')
