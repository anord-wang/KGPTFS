...
for i in range(EXPLORE_STEPS):
    ...
    L_s = LaplacianScore(X_selected, neighbour_size=4, t_param=2)
    print(L_s)
    L_s_reward = math.pow(-1, Faction) * L_s[t]
    ...
    r = (accuracy - ave_corr + L_s_reward)
    # r = accuracy
...
out.to_csv(result_folder + 'ls_result.csv', mode='a')
