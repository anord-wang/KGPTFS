...
knockoff_EPSILON = 2  # 在随机选择中使用knockoff标签的比例
GAMMA = 0.9
...
for model_index in range(model_num):
    ...
    output.append(str(model_index + 1) + 'mutil reg method knockoff no greedy with reconstruction.')
    reward_output.append(str(model_index + 1) + 'mutil reg method knockoff no greedy with reconstruction.')
