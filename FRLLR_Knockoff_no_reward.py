...
for model_index in range(model_num):
    ...
    output.append(str(model_index + 1) + 'mutil reg method knockoff no reward with reconstruction.')
    reward_output.append(str(model_index + 1) + 'mutil reg method knockoff no reward with reconstruction.')
