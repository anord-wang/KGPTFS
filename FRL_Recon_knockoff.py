...
output.append('knockoff with reconstruction. knockoff threshold median no pretrain')
reward_output.append('knockoff with reconstruction. knockoff threshold median no pretrain')
