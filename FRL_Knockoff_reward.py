...
for i in range(EXPLORE_STEPS):
    t = i % T
    Factionvalue = dqn.choose_action(s)
    print('Factionvalue:', Factionvalue)
    Faction = Factionvalue.index(max(Factionvalue))
...
out.to_csv(result_folder + 'reward_test.csv', mode='a')
