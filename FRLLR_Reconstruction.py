...
for dataset_name in name_list:
    ...
    EXPLORE_STEPS = 20 * N_feature  # How many exploration steps you'd like, should be larger than MEMORY_CAPACITY20
    VAL_STEPS = N_feature
    N_ACTIONS = 2
    ...
    print('Fstate: ', Fstate, sum(Fstate))
    ...
    for i in range(EXPLORE_STEPS):
        ...
        a_1 = 1
        # r = (a_1 - reconstruction_loss.detach().numpy() - ave_corr)
        r = (a_1 - compareLodge_loss.detach().numpy() - ave_corr)
        # r = (a_1 - compareLodge_loss.detach().numpy())
        # b_1 = 0
        # r = (b_1 - compare_loss - ave_corr)
    ...
    for model_index in range(model_num):
        ...
        output.append('many many models, No '+str(model_index+1)+'Only Reconstruction compare loss reward')
        reward_output.append('many many models, No '+str(model_index+1)+'Only Reconstruction compare loss reward')
