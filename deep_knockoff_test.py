...
# from DeepKnockoffs import machine, gaussian
# from DeepKnockoffs.gaussian import GaussianKnockoffs
# from dk import data, diagnostics, parameters, machine, gaussian
from dk import data, parameters, machine, gaussian
...
second_order = gaussian.GaussianKnockoffs(SigmaHat, mu=np.mean(X_train, 0), method="sdp")
...
machine = machine.KnockoffMachine(pars)
...
oracle = gaussian.GaussianKnockoffs(DataSampler.Sigma, method="sdp", mu=DataSampler.mu)
...
# n_exams = 50
# n_samples = 100
# exam = diagnostics.KnockoffExam(DataSampler, {'Oracle': oracle, 'Machine': machine, 'Second-order': second_order})
