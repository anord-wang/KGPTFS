...
# cls_name = []
# reg_name = ['housing_boston', 'openml_586', 'openml_589', 'openml_607',
#             'openml_616', 'openml_618', 'openml_620', 'openml_637']
# cls_name = ['HumanActivity', 'cs', 'phpDYCOet']
cls_name = []
reg_name = ['airfoil']
...
for dataset_name in name_list:
    ...
    for model_index in range(model_num):
        ...
        output.append('knockoff with reconstruction. knockoff threshold median no pretrain, many many models, No ' + str(model_index + 1))
        reward_output.append('knockoff with reconstruction. knockoff threshold median no pretrain, many many models, No ' + str(model_index + 1))
