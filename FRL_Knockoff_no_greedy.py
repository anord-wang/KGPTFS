...
for model_index in range(8):
    ...
    output.append(str(model_index+1)+'mutil cla method knockoff no greedy with reconstruction.')
    reward_output.append(str(model_index+1)+'mutil cla method knockoff no greedy with reconstruction.')
