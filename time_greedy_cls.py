...
knockoff_EPSILON = 1  # 在随机选择中使用knockoff标签的比例
GAMMA = 0.9
...
for model_index in range(8):
    ...
    output.append(str(model_index+1)+'mutil cla method 0 10 90.')
    reward_output.append(str(model_index+1)+'mutil cla method knockoff with reconstruction.')
    ...
    out_1.to_csv(result_folder + dataset_name + '_test_time_greedy.csv', mode='a')
